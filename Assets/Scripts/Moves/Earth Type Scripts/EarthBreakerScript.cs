...
public class EarthBreakerScript : MonoBehaviour, IMove
{
    ...
    public void Start()
    {
        ...
        attackPower = Random.Range(60, 80);
    ...
    public void EarthBreakerAttack()
    {
        ...
        Debug.Log(AttackerName + " used Earth Breaker!");
