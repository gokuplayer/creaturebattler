...
public class ShadowSphereScript : MonoBehaviour, IMove
{
    ...
    public void Start()
    {
        ...
        attackPower = Random.Range(20, 40);
    ...
    public void ShadowSphereAttack()
    {
        ...
        Debug.Log(AttackerName + " used Shadow Sphere!");
