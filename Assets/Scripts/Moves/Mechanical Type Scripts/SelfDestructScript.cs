...
public class SelfDestructScript : MonoBehaviour, IMove
{
    ...
    public void Start()
    {
        ...
        attackPower = Random.Range(140, 160);
    ...
    public void SelfDestructAttack()
    {
        ...
        Debug.Log(AttackerName + " used Self Destruct!");
